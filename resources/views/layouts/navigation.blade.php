        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('sudoku.index') }}" class="text-lg font-bold text-gray-800 dark:text-gray-200">
                        Puzzlebox
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="flex items-center space-x-4 text-sm">
                        ...
                        <a href="{{ route('register') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
                            Register
                        </a>
                    </div>
                @endauth
